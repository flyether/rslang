            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        api_1.api.GetsStatistics(userId)
                            ...
                            var _a;
                            if (res) {
                                _this.statisticsFromServer = res;
                                console.log('this.statisticsFromServer в гетстатистике', _this.statisticsFromServer, 'res', res);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        value = this.statisticsFromServer;
                        ...
                        if (this.round < countWord) {
                            ...
                            if (userId) {
                                ...
                                this.staticGet().then(function () {
                                    ...
                                    if (_this.objStatistic.newWords) {
                                    ...
                                    if (_this.objStatistic.AllAnswersFromGame) {
                                    ...
                                    if (_this.objStatistic.rightAnswers) {
                                        ...
                                        _this.objStatistic.percentOfRightAnswers = 0;
                                    }
