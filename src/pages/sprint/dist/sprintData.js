...
exports.sprintData = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.userID !== 'no')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.checkLearnedWordsInAnswers()];
                    case 1:
                        _a.sent();
    ...
    checkLearnedWordsInAnswers: function () {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_1.api.getAllUserWords(this.userID)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/];
                }
    ...
    updateobjSprintDate: function (obj) {
        console.log(obj);
        exports.objSprintDate.newWords = obj.newWords;
        exports.objSprintDate.longestSeriesOfRightAnswers = obj.longestSeriesOfRightAnswers;
        exports.objSprintDate.percentOfRightAnswers = obj.percentOfRightAnswers;
        exports.objSprintDate.longestSeriesOfRightAnswersSprint = (obj.longestSeriesOfRightAnswersSprint > this.longestSeries)
            ? obj.longestSeriesOfRightAnswersSprint : this.longestSeries;
        exports.objSprintDate.AllAnswersFromGameSprint = obj.AllAnswersFromGameSprint + this.amountOfAllAnswers;
        exports.objSprintDate.rightAnswersSprint = obj.rightAnswersSprint + this.amountOfRightAnswers;
